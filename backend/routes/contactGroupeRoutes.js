...
router.post('/contacts/group', isAuthentificated, checkRole( 'super-administrateur','administrateur'), ContactGroupeController.associateContactsToGroup);
...
router.delete('/delete', isAuthentificated, checkRole( 'super-administrateur','administrateur'), ContactGroupeController.disassociateContactsFromGroup);
